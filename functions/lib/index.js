...
exports.notifyAccepted = exports.notifyRequest = void 0;
...
exports.notifyRequest = functions.https.onRequest({ cors: true }, async (req, res) => {
    if (req.method !== "POST") {
...
exports.notifyAccepted = functions.https.onRequest({ cors: true }, async (req, res) => {
    if (req.method !== "POST") {
        res.status(405).send("Method Not Allowed");
        return;
    }
    const { clientName, professionalName, clientEmail, professionalEmail, serviceTitle, dateStr, startTime, location, totalCost, } = req.body;
